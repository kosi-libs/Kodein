 ...
 */
inline fun <reified T: Any> DI.Builder.eagerSingleton(noinline creator: NoArgSimpleBindingDI<Any>.() -> T) = EagerSingleton(containerBuilder, org.kodein.type.generic(), creator)
 ...
 */
inline fun <reified T: Any> DI.Builder.instance(instance: T) = InstanceBinding(org.kodein.type.generic(), instance)
