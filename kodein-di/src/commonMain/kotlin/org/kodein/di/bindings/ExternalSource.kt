...
public interface ExternalSource {
     ...
     */
    public fun getFactory(di: BindingInfo<*>, key: DI.Key<*, *, *>): ((Any?) -> Any)?
    ...
    public companion object {
         ...
         */
        public inline operator fun invoke(crossinline f: BindingInfo<*>.(DI.Key<*, *, *>) -> ((Any?) -> Any)?): ExternalSource = object : ExternalSource {
            override fun getFactory(di: BindingInfo<*>, key: DI.Key<*, *, *>): ((Any?) -> Any)? = di.f(key)
        }
    }
}
