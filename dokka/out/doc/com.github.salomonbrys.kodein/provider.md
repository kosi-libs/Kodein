...
`inline fun <reified T : Any> `[`Builder`](-kodein/-builder/index.md)`.provider(noinline creator: `[`ProviderKodein`](-provider-kodein/index.md)`.() -> T): `[`Provider`](-provider/index.md)`<T>`
