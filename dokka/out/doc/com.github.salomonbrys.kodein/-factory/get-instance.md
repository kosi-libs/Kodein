[com.github.salomonbrys.kodein](../index.md) / [Factory](index.md) / [getInstance](.)

# getInstance

`abstract fun getInstance(kodein: `[`Kodein`](../-kodein/index.md)`, key: `[`Key`](../-kodein/-key/index.md)`, arg: A): T`
