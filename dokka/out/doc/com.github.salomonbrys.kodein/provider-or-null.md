...
`inline fun <A, reified T : Any> `[`CurriedInjectorFactory`](-curried-injector-factory/index.md)`<A>.providerOrNull(tag: Any? = null): Lazy<() -> T>`
...
`inline fun <A, reified T : Any> `[`CurriedLazyKodeinFactory`](-curried-lazy-kodein-factory/index.md)`<A>.providerOrNull(tag: Any? = null): Lazy<() -> T>`
...
`inline fun <A, reified T : Any> `[`CurriedKodeinFactory`](-curried-kodein-factory/index.md)`<A>.providerOrNull(tag: Any? = null): () -> T`
