[com.github.salomonbrys.kodein](index.md) / [genericInstance](.)

# genericInstance

`inline fun <reified T : Any> `[`Builder`](-kodein/-builder/index.md)`.genericInstance(instance: T): `[`CInstance`](-c-instance/index.md)`<T>`
...
`inline fun <reified T : Any> `[`KodeinInjectedBase`](-kodein-injected-base/index.md)`.genericInstance(tag: Any? = null): `[`InjectedProperty`](-injected-property/index.md)`<T>`
...
`inline fun <A, reified T : Any> `[`CurriedInjectorFactory`](-curried-injector-factory/index.md)`<A>.genericInstance(tag: Any? = null): Lazy<T>`
...
`inline fun <reified T : Any> `[`LazyKodeinAwareBase`](-lazy-kodein-aware-base/index.md)`.genericInstance(tag: Any? = null): Lazy<T>`
...
`inline fun <A, reified T : Any> `[`CurriedLazyKodeinFactory`](-curried-lazy-kodein-factory/index.md)`<A>.genericInstance(tag: Any? = null): Lazy<T>`
...
`inline fun <reified T : Any> `[`KodeinAwareBase`](-kodein-aware-base/index.md)`.genericInstance(tag: Any? = null): T`
...
`inline fun <A, reified T : Any> `[`CurriedKodeinFactory`](-curried-kodein-factory/index.md)`<A>.genericInstance(tag: Any? = null): T`
