...
`inline fun <reified T : Any> `[`CurriedKodeinFactory`](-curried-kodein-factory/index.md)`<*>.genericInstance(tag: Any? = null): T`
...
`inline fun <reified T : Any> `[`CurriedLazyKodeinFactory`](-curried-lazy-kodein-factory/index.md)`<*>.genericInstance(tag: Any? = null): Lazy<T>`
...
`inline fun <reified T : Any> `[`CurriedInjectorFactory`](-curried-injector-factory/index.md)`<*>.genericInstance(tag: Any? = null): Lazy<T>`
