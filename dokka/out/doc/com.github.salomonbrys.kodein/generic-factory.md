...
`inline fun <reified A, reified T : Any> `[`Builder`](-kodein/-builder/index.md)`.genericFactory(noinline creator: `[`Kodein`](-kodein/index.md)`.(A) -> T): `[`CFactory`](-c-factory/index.md)`<A, T>`
