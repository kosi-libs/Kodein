...
`inline fun <reified A, reified T : Any> `[`Builder`](-kodein/-builder/index.md)`.erasedFactory(noinline creator: `[`FactoryKodein`](-factory-kodein/index.md)`.(A) -> T): `[`Factory`](-factory/index.md)`<A, T>`
