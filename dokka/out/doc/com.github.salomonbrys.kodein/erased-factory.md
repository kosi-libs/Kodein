[com.github.salomonbrys.kodein](index.md) / [erasedFactory](.)

# erasedFactory

`inline fun <reified A, reified T : Any> `[`Builder`](-kodein/-builder/index.md)`.erasedFactory(noinline creator: `[`FactoryKodein`](-factory-kodein/index.md)`.(A) -> T): `[`CFactory`](-c-factory/index.md)`<A, T>`
