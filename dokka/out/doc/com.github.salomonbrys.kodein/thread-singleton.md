...
`inline fun <reified T : Any> `[`Builder`](-kodein/-builder/index.md)`.threadSingleton(noinline creator: `[`ProviderKodein`](-provider-kodein/index.md)`.() -> T): `[`AProvider`](-a-provider/index.md)`<T>`
