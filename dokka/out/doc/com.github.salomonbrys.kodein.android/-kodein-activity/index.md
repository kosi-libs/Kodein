[com.github.salomonbrys.kodein.android](../index.md) / [KodeinActivity](.)

# KodeinActivity

`abstract class KodeinActivity : Activity, `[`ActivityInjector`](../-activity-injector/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `KodeinActivity()`<br>A base class that manages an [ActivityInjector](../-activity-injector/index.md) for easy bootstrapping of Kodein.
Injections will be available after `super.onCreate` and will be destroyed after `super.onDestroy`. |
...
| [kodeinComponent](kodein-component.md) | `val kodeinComponent: Activity`<br>A convenient way for sub-interfaces to reference the component (for internal use only) |
| [kodeinScope](kodein-scope.md) | `val kodeinScope: `[`AndroidScope`](../-android-scope/index.md)`<Activity>`<br>The scope that this component belongs to (for internal use only) |
