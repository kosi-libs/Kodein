[com.github.salomonbrys.kodein.android](../index.md) / [FragmentActivityInjector](.)

# FragmentActivityInjector

`interface FragmentActivityInjector : `[`AndroidInjector`](../-android-injector/index.md)`<FragmentActivity, `[`AndroidScope`](../-android-scope/index.md)`<FragmentActivity>>`

An interface for adding injection and bindings to a FragmentActivity.

The following bindings are provided:

* [KodeinInjected](../../com.github.salomonbrys.kodein/-kodein-injected.md) = this@FragmentActivity
...
| Name | Summary |
|---|---|
| [kodeinScope](kodein-scope.md) | `open val kodeinScope: `[`AndroidScope`](../-android-scope/index.md)`<FragmentActivity>`<br>The scope that this component belongs to (for internal use only) |
...
| Name | Summary |
|---|---|
| [KodeinFragmentActivity](../-kodein-fragment-activity/index.md) | `abstract class KodeinFragmentActivity : FragmentActivity, FragmentActivityInjector`<br>A base class that manages a FragmentActivityInjector for easy bootstrapping of Kodein.
