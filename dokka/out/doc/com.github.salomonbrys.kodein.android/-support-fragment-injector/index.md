[com.github.salomonbrys.kodein.android](../index.md) / [SupportFragmentInjector](.)

# SupportFragmentInjector

`interface SupportFragmentInjector : `[`AndroidInjector`](../-android-injector/index.md)`<Fragment, `[`AndroidScope`](../-android-scope/index.md)`<Fragment>>`

An interface for adding injection and bindings to a android.support.v4.app.Fragment.

The following bindings are provided:

* [KodeinInjected](../../com.github.salomonbrys.kodein/-kodein-injected.md) = this@android.support.v4.app.Fragment
...
| Name | Summary |
|---|---|
| [KodeinSupportFragment](../-kodein-support-fragment/index.md) | `abstract class KodeinSupportFragment : Fragment, SupportFragmentInjector`<br>A base class that manages a SupportFragmentInjector for easy bootstrapping of Kodein.
