[com.github.salomonbrys.kodein.android](../index.md) / [KodeinPreferenceFragment](.)

# KodeinPreferenceFragment

`abstract class KodeinPreferenceFragment : PreferenceFragment, `[`FragmentInjector`](../-fragment-injector/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `KodeinPreferenceFragment()`<br>A base class that manages a [FragmentInjector](../-fragment-injector/index.md) for easy bootstrapping of Kodein.
Injections will be available after `super.onCreate` and will be destroyed after `super.onDestroy`. |
