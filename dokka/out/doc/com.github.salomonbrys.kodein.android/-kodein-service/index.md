[com.github.salomonbrys.kodein.android](../index.md) / [KodeinService](.)

# KodeinService

`abstract class KodeinService : Service, `[`ServiceInjector`](../-service-injector/index.md)

A base class that manages a [ServiceInjector](../-service-injector/index.md) for easy bootstrapping of Kodein.
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `KodeinService()`<br>A base class that manages a [ServiceInjector](../-service-injector/index.md) for easy bootstrapping of Kodein.
Injections will be available after `super.onCreate` and will be destroyed after `super.onDestroy`. |
...
| [kodeinComponent](kodein-component.md) | `val kodeinComponent: Service`<br>A convenient way for sub-interfaces to reference the component (for internal use only) |
| [kodeinScope](kodein-scope.md) | `val kodeinScope: `[`AndroidScope`](../-android-scope/index.md)`<Service>`<br>The scope that this component belongs to (for internal use only) |
