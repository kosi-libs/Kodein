...
`inline fun <A, reified T : Any> `[`CurriedInjectorFactory`](../com.github.salomonbrys.kodein/-curried-injector-factory/index.md)`<A>.instance(tag: Any? = null): Lazy<T>`
...
`inline fun <A, reified T : Any> `[`CurriedLazyKodeinFactory`](../com.github.salomonbrys.kodein/-curried-lazy-kodein-factory/index.md)`<A>.instance(tag: Any? = null): Lazy<T>`
...
`inline fun <A, reified T : Any> `[`CurriedKodeinFactory`](../com.github.salomonbrys.kodein/-curried-kodein-factory/index.md)`<A>.instance(tag: Any? = null): T`
