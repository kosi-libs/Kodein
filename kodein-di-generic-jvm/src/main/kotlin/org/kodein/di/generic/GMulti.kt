...
inline fun <C, reified A1, reified A2,                                     reified T: Any> DI.BindBuilder.WithContext<C>.factory(noinline creator: BindingDI<C>.(A1, A2            ) -> T) = Factory(contextType, generic<Multi2<A1, A2            >>(), generic()) { creator(it.a1, it.a2                     ) }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <C, reified A1, reified A2, reified A3,                         reified T: Any> DI.BindBuilder.WithContext<C>.factory(noinline creator: BindingDI<C>.(A1, A2, A3        ) -> T) = Factory(contextType, generic<Multi3<A1, A2, A3        >>(), generic()) { creator(it.a1, it.a2, it.a3              ) }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <C, reified A1, reified A2, reified A3, reified A4,             reified T: Any> DI.BindBuilder.WithContext<C>.factory(noinline creator: BindingDI<C>.(A1, A2, A3, A4    ) -> T) = Factory(contextType, generic<Multi4<A1, A2, A3, A4    >>(), generic()) { creator(it.a1, it.a2, it.a3, it.a4       ) }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <C, reified A1, reified A2, reified A3, reified A4, reified A5, reified T: Any> DI.BindBuilder.WithContext<C>.factory(noinline creator: BindingDI<C>.(A1, A2, A3, A4, A5) -> T) = Factory(contextType, generic<Multi5<A1, A2, A3, A4, A5>>(), generic()) { creator(it.a1, it.a2, it.a3, it.a4, it.a5) }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <C, reified A1, reified A2,                                     reified T: Any> DI.BindBuilder.WithScope<C>.multiton(ref: RefMaker? = null, sync: Boolean = true, noinline creator: SimpleBindingDI<C>.(A1, A2            ) -> T) = Multiton(scope, contextType, generic<Multi2<A1, A2            >>(), generic(), ref, sync) { creator(it.a1, it.a2                     ) }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <C, reified A1, reified A2, reified A3,                         reified T: Any> DI.BindBuilder.WithScope<C>.multiton(ref: RefMaker? = null, sync: Boolean = true, noinline creator: SimpleBindingDI<C>.(A1, A2, A3        ) -> T) = Multiton(scope, contextType, generic<Multi3<A1, A2, A3        >>(), generic(), ref, sync) { creator(it.a1, it.a2, it.a3              ) }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <C, reified A1, reified A2, reified A3, reified A4,             reified T: Any> DI.BindBuilder.WithScope<C>.multiton(ref: RefMaker? = null, sync: Boolean = true, noinline creator: SimpleBindingDI<C>.(A1, A2, A3, A4    ) -> T) = Multiton(scope, contextType, generic<Multi4<A1, A2, A3, A4    >>(), generic(), ref, sync) { creator(it.a1, it.a2, it.a3, it.a4       ) }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <C, reified A1, reified A2, reified A3, reified A4, reified A5, reified T: Any> DI.BindBuilder.WithScope<C>.multiton(ref: RefMaker? = null, sync: Boolean = true, noinline creator: SimpleBindingDI<C>.(A1, A2, A3, A4, A5) -> T) = Multiton(scope, contextType, generic<Multi5<A1, A2, A3, A4, A5>>(), generic(), ref, sync) { creator(it.a1, it.a2, it.a3, it.a4, it.a5) }
...
inline fun <reified A1, reified A2,                                     reified T: Any> DIAware.factory2(tag: Any? = null) =
        DIPropertyMap(Factory<Multi2<A1, A2            >, T>(generic(), generic(), tag)) { { a1: A1, a2: A2                         -> it(M(a1, a2            )) } }
...
inline fun <reified A1, reified A2, reified A3,                         reified T: Any> DIAware.factory3(tag: Any? = null) =
        DIPropertyMap(Factory<Multi3<A1, A2, A3        >, T>(generic(), generic(), tag)) { { a1: A1, a2: A2, a3: A3                 -> it(M(a1, a2, a3        )) } }
...
inline fun <reified A1, reified A2, reified A3, reified A4,             reified T: Any> DIAware.factory4(tag: Any? = null) =
        DIPropertyMap(Factory<Multi4<A1, A2, A3, A4    >, T>(generic(), generic(), tag)) { { a1: A1, a2: A2, a3: A3, a4: A4         -> it(M(a1, a2, a3, a4    )) } }
...
inline fun <reified A1, reified A2, reified A3, reified A4, reified A5, reified T: Any> DIAware.factory5(tag: Any? = null) =
        DIPropertyMap(Factory<Multi5<A1, A2, A3, A4, A5>, T>(generic(), generic(), tag)) { { a1: A1, a2: A2, a3: A3, a4: A4, a5: A5 -> it(M(a1, a2, a3, a4, a5)) } }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <reified A1, reified A2,                                     reified T: Any> DIAware.factory2OrNull(tag: Any? = null) =
        DIPropertyMap(FactoryOrNull<Multi2<A1, A2            >, T>(generic(), generic(), tag)) { factory -> factory?.let { { a1: A1, a2: A2                         -> it(M(a1, a2            )) } } }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <reified A1, reified A2, reified A3,                         reified T: Any> DIAware.factory3OrNull(tag: Any? = null) =
        DIPropertyMap(FactoryOrNull<Multi3<A1, A2, A3        >, T>(generic(), generic(), tag)) { factory -> factory?.let { { a1: A1, a2: A2, a3: A3                 -> it(M(a1, a2, a3        )) } } }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <reified A1, reified A2, reified A3, reified A4,             reified T: Any> DIAware.factory4OrNull(tag: Any? = null) =
        DIPropertyMap(FactoryOrNull<Multi4<A1, A2, A3, A4    >, T>(generic(), generic(), tag)) { factory -> factory?.let { { a1: A1, a2: A2, a3: A3, a4: A4         -> it(M(a1, a2, a3, a4    )) } } }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <reified A1, reified A2, reified A3, reified A4, reified A5, reified T: Any> DIAware.factory5OrNull(tag: Any? = null) =
        DIPropertyMap(FactoryOrNull<Multi5<A1, A2, A3, A4, A5>, T>(generic(), generic(), tag)) { factory -> factory?.let { { a1: A1, a2: A2, a3: A3, a4: A4, a5: A5 -> it(M(a1, a2, a3, a4, a5)) } } }
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <reified A1, reified A2, reified A3,                         reified T: Any> DirectDI.factory3OrNull(tag: Any? = null) =
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <reified A1, reified A2, reified A3, reified A4,             reified T: Any> DirectDI.factory4OrNull(tag: Any? = null) =
...
@Deprecated(message="Multi argument factories are confusing for lot of users, " +
        ...
        " (see https://github.com/Kodein-Framework/Kodein-DI/issues/240) " +
        " This will be removed in 7.0 ")
inline fun <reified A1, reified A2, reified A3, reified A4, reified A5, reified T: Any> DirectDI.factory5OrNull(tag: Any? = null) =
