...
class ErasedJvmTests {
    ...
    @Test fun test15_01_BindingsFullDescription() {
        ...
        assertTrue("bind<kotlin.String>(tag = \"scoped\") with scopedSingleton(com.github.salomonbrys.kodein.test.ErasedJvmTests.test15Scope) { kotlin.Unit -> kotlin.String }" in lines)
        assertTrue("bind<kotlin.String>(tag = \"auto-scoped\") with autoScopedSingleton(com.github.salomonbrys.kodein.test.ErasedJvmTests.test15Scope) { kotlin.String }" in lines)
    }
