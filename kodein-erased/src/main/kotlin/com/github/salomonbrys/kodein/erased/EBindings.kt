...
inline fun <reified A, reified T : Any> Kodein.Builder.refMultiton(refMaker: RefMaker, noinline creator: BindingKodein.(A) -> T)
    = RefMultitonBinding(erased(), erased(), refMaker, creator)
...
inline fun <reified T : Any> Kodein.Builder.sequence(noinline creator: suspend SequenceBindingKodein<T>.() -> Unit) = SequenceBinding(erased(), creator)
