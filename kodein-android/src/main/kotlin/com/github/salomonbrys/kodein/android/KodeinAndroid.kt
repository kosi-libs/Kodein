...
public fun View.lazyKodeinFromApp() = LazyKodein(lazy { (context.applicationContext as KodeinApplication).kodein })

public fun AbstractThreadedSyncAdapter.lazyKodeinFromApp() = LazyKodein(lazy { (context.applicationContext as KodeinApplication).kodein })

public fun Loader<*>.lazyKodeinFromApp() = LazyKodein(lazy { (context.applicationContext as KodeinApplication).kodein })

public fun android.support.v4.content.Loader<*>.lazyKodeinFromApp() = LazyKodein(lazy { (context.applicationContext as KodeinApplication).kodein })
...
public val View.appKodein: () -> Kodein get() = { (context.applicationContext as KodeinApplication).kodein }

public val AbstractThreadedSyncAdapter.appKodein: () -> Kodein get() = { (context.applicationContext as KodeinApplication).kodein }

public val Loader<*>.appKodein: () -> Kodein get() = { (context.applicationContext as KodeinApplication).kodein }

public val android.support.v4.content.Loader<*>.appKodein: () -> Kodein get() = { (context.applicationContext as KodeinApplication).kodein }
