...
internal open class KodeinImpl internal constructor(private val _container: KodeinContainerImpl) : Kodein {
    ...
    @Suppress("unused")
    private constructor(builder: KodeinMainBuilderImpl, runCallbacks: Boolean) : this(KodeinContainerImpl(builder.containerBuilder, builder.externalSources, runCallbacks))
