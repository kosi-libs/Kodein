...
NOTE: Using or not using this is a matter of taste and is not recommended nor discouraged.
...
You can import modules or extend kodein objects inside this global kodein using `Kodein.global.addImport`, `Kodein.global.addExtend` and `Kodein.global.addConfig`.
...
The API documentation can be found https://github.com/SalomonBrys/Kodein/blob/master/dokka/out/doc/index.md[here]!
