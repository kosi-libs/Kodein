 ...
 */
inline fun <C, reified A, reified T: Any> Kodein.BindBuilder.Contexted<C>.factory(noinline creator: BindingKodein<C>.(A) -> T) = Factory<C, A, T>(contextType, generic(), generic(), creator)
 ...
 */
inline fun <C, reified T: Any> Kodein.BindBuilder.Contexted<C>.provider(noinline creator: NoArgBindingKodein<C>.() -> T) = Provider(contextType, generic(), creator)
 ...
 */
inline fun <reified T: Any> Kodein.Builder.eagerSingleton(noinline creator: NoArgSimpleBindingKodein<Any?>.() -> T) = EagerSingleton(this, generic(), creator)
