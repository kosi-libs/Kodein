...
fun <T : Any> CurriedInjectorFactory<*>.Provider(type: TypeToken<T>, tag: Any? = null): Lazy<() -> T> = injector.Factory(argType, type, tag).toProvider(arg)
 ...
 * @throws Kodein.DependencyLoopException When calling the provider, if the value construction triggered a dependency loop.
 */
fun <T : Any> CurriedInjectorFactory<*>.ProviderOrNull(type: TypeToken<T>, tag: Any? = null): Lazy<(() -> T)?> = injector.FactoryOrNull(argType, type, tag).toProviderOrNull(arg)
 ...
 * @throws KodeinInjector.UninjectedException When accessing the property, if it was accessed before calling [KodeinInjectedBase.inject].
 */
fun <T : Any> CurriedInjectorFactory<*>.Instance(type: TypeToken<T>, tag: Any? = null): Lazy<T> = injector.Factory(argType, type, tag).toInstance(arg)
 ...
 * @throws KodeinInjector.UninjectedException When accessing the property, if it was accessed before calling [KodeinInjectedBase.inject].
 */
fun <T : Any> CurriedInjectorFactory<*>.InstanceOrNull(type: TypeToken<T>, tag: Any? = null): Lazy<T?> = injector.FactoryOrNull(argType, type, tag).toInstanceOrNull(arg)
