...
fun <A, T : Any> KodeinAwareBase.Factory(argType: TypeToken<out A>, type: TypeToken<T>, tag: Any? = null): KodeinProperty<(A) -> T> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.factory(Kodein.Key(Kodein.Bind(type, tag), argType), receiver) }
...
fun <A, T : Any> KodeinAwareBase.FactoryOrNull(argType: TypeToken<out A>, type: TypeToken<T>, tag: Any? = null): KodeinProperty<((A) -> T)?> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.factoryOrNull(Kodein.Key(Kodein.Bind(type, tag), argType), receiver) }
...
fun <T : Any> KodeinAwareBase.Provider(type: TypeToken<T>, tag: Any? = null): KodeinProperty<() -> T> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.provider(Kodein.Bind(type, tag), receiver) }

fun <A, T : Any> KodeinAwareBase.Provider(argType: TypeToken<out A>, type: TypeToken<T>, tag: Any? = null, arg: () -> A): KodeinProperty<() -> T> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.factory(Kodein.Key(Kodein.Bind(type, tag), argType), receiver).toProvider(arg) }
...
fun <T : Any> KodeinAwareBase.ProviderOrNull(type: TypeToken<T>, tag: Any? = null): KodeinProperty<(() -> T)?> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.providerOrNull(Kodein.Bind(type, tag), receiver) }

fun <A, T : Any> KodeinAwareBase.ProviderOrNull(argType: TypeToken<out A>, type: TypeToken<T>, tag: Any? = null, arg: () -> A): KodeinProperty<(() -> T)?> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.factoryOrNull(Kodein.Key(Kodein.Bind(type, tag), argType), receiver)?.toProvider(arg) }
...
fun <T : Any> KodeinAwareBase.Instance(type: TypeToken<T>, tag: Any? = null): KodeinProperty<T> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.provider(Kodein.Bind(type, tag), receiver).invoke() }

fun <A, T : Any> KodeinAwareBase.Instance(argType: TypeToken<out A>, type: TypeToken<T>, tag: Any? = null, arg: () -> A): KodeinProperty<T> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.factory(Kodein.Key(Kodein.Bind(type, tag), argType), receiver).invoke(arg()) }
...
fun <T : Any> KodeinAwareBase.InstanceOrNull(type: TypeToken<T>, tag: Any? = null): KodeinProperty<T?> =
        KodeinProperty(propMode, injector) { receiver -> kodein.container.providerOrNull(Kodein.Bind(type, tag), receiver)?.invoke() }
