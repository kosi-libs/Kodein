...
NOTE: These `subDI` function are similar to the *_Kodein-DI_* core `subDI`.
      Check xref:core:modules-inheritance.adoc#extension-composition[this documentation] for more advanced usages.
