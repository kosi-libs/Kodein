...
&lt;dependency&gt;
    ...
    &lt;artifactId&gt;kodein-conf-jvm&lt;/artifactId&gt;
...
----
compile 'org.kodein:kodein-conf-jvm:{version}'
----
...
[source,groovy,subs="attributes"]
----
compile 'org.kodein:kodein-conf-js:{version}'
----
...
- https://bintray.com/salomonbrys/kodein/download_file?file_path=kodein-conf-native-{version}.klib[Download the kodein-conf-native-{version} klib].
