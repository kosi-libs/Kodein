...
This feature is restricted to the `Routing` / `Route`, but can be used like:
...
<2> extending the nearest Kodein instance, the one created in the <1>
<3> extending the nearest Kodein instance, the one created in the <2>
