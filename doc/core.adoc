...
- https://dl.bintray.com/salomonbrys/kodein-di/native/kodein-di-{version}/kodein-di-core-{version}.klib[Download kodein-core-{version}.klib].
- https://dl.bintray.com/salomonbrys/kodein-di/native/kodein-di-{version}/kodein-di-erased-{version}.klib[Download kodein-erased-{version}.klib].
...
Read the https://salomonbrys.github.io/Kodein/?{branch}/advanced[advanced usage document] ;).
