...
- https://bintray.com/salomonbrys/kodein/download_file?file_path=kodein-core-native-{version}.klib[Download the kodein-core-native-{version} klib].
- https://bintray.com/salomonbrys/kodein/download_file?file_path=kodein-erased-native-{version}.klib[Download the kodein-erased-native-{version} klib].
