...
+
WARNING: We highly recommand that you make your `App` as `KodeinAware` in order to benefit from the use of Kodein upon TornadoFX DI container.
...
To keep your binding from the global Kodein container you can use link:tornadofx.adoc#core#_extension_composition[extension] or following the next about link:tornadofx.adoc#sub-kodein[subKodein]
