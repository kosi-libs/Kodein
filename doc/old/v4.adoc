= KOtlin DEpendency INjection V4
...
image:https://img.shields.io/maven-central/v/org.kodein/kodein.svg[alt="Maven Central", link="https://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.kodein%22"]
...
----
compile 'org.kodein:kodein:{version}'
----
...
----
compile 'org.kodein:kodein:{version}'
compile 'org.kodein:kodein-android:{version}'
----
+
...
[source,groovy,subs="attributes"]
----
compile 'org.kodein:kodein-js-conf:{version}'
----
...
[source,groovy,subs="attributes"]
----
compile 'org.kodein:kodein-jxinject:{version}'
----
...
NOTE: The inline function set that alias with the `erased` function is located in a different package than the regular one: `org.kodein.erased`.
