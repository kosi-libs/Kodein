 ...
 */
inline fun <reified T: Any> Kodein.Builder.singleton(noinline creator: NoArgSimpleBindingKodein.() -> T) = SingletonBinding(generic(), creator)
 ...
 */
inline fun <reified T: Any> Kodein.Builder.eagerSingleton(noinline creator: NoArgSimpleBindingKodein.() -> T) = EagerSingletonBinding(this, generic(), creator)
 ...
 */
inline fun <reified T: Any> Kodein.Builder.refSingleton(refMaker: RefMaker, noinline creator: NoArgSimpleBindingKodein.() -> T)
 ...
 */
inline fun <reified A, reified T: Any> Kodein.Builder.refMultiton(refMaker: RefMaker, noinline creator: SimpleBindingKodein.(A) -> T)
