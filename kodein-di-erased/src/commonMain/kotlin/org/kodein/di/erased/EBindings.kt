 ...
 */
inline fun <EC, BC, reified T: Any> Kodein.BindBuilder.WithScope<EC, BC>.singleton(ref: RefMaker? = null, sync: Boolean = true, noinline creator: NoArgSimpleBindingKodein<BC>.() -> T) = Singleton(scope, contextType, erased(), ref, sync, creator)
 ...
 */
inline fun <EC, BC, reified A, reified T: Any> Kodein.BindBuilder.WithScope<EC, BC>.multiton(ref: RefMaker? = null, sync: Boolean = true, noinline creator: SimpleBindingKodein<BC>.(A) -> T) = Multiton<EC, BC, A, T>(scope, contextType, erased(), erased(), ref, sync, creator)
